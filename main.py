...
model.wczytaj_model("36_100000")
#model.train(*train_data)
model.evaluate(*test_data)
#model.zapisz_model("n1")
...
#for j in [-5, -6, -7]:
#    step = 10**j
#    model = LinearClasiffier(metoda="localsearch",iters=10000,step=step)
#    model.train(*train_data)
#    i, ls = model.get_loss()
#    sre = model.evaluate(*test_data)
#    plt.plot(i, ls, label = j)
